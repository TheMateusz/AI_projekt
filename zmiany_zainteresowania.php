                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class=" row justify-content-center">
                                    ...
                                    <div class="colzmianyele col-10">
                                        <form method="post" >
                                            <div class="row justify-content-center">
                                                <div class="text-center col-12">
                                                    <br>
                                                    <h2>ZMIANA ZAINTERESOWAŃ</h2>
                                                </div>
                                                <div class="col-sm-1 col-md-1 col-lg-1 phone text-center">
                                                </div>
                                                <div class="col-sm-1 col-md-1 col-lg-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="GOTOWANIE">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="gotowanie" name="checkbox[]">
                                                ...
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="ŁUCZNICTWO">
                                                        <label class="main2">
                                                          ...
                                                          <input class="checkl" type="checkbox"  value="lucznictwo" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="KOLARSTWO">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="kolarstwo" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="GRY PLANSZOWE">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox" value="gry_planszowe" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="KSIĄŻKI">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="ksiazki" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="SAMOCHODY">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="samochody" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="NURKOWANIE">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="nurkowanie" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="MECHANIKA">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="mechanika" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="ŁOWIENIE RYB">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="lowienie_ryb" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="MOTORY">
                                                        <label class="main2">
                                                          ...
                                                          <input  class="checkl" type="checkbox"  value="motory" name="checkbox[]">
                                                          <span class="mark2"></span>
                                                    </label></a>
                                                </div>
                                                <div class="col-1 col-sm-1 text-center">
                                                ...
                                                <div class="col-1 col-sm-1 text-center">
                                                    <a href="#" data-toggle="tooltip" title="ZWIERZĘTA">
                                                        <label class="main2">
                                            ...
                                            <div class="col-6 offset-3">
                                                <button class="regbutton" name="change_hobby" type="submit">ZAPISZ USTAWIENIA</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>    
