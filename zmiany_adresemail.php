                    ...
                    <div class="col-2 menuleftcol text-center">
                        <div class="row">
                            <div class='menufriend col-12 text-center'>
                                ...
                                <div class='menufriend col-12 text-center'>
                                    <a href='zmiany.php'><button type='submit' class='menufrienditem2' name='get_user'>PODSTAWOWE DANE</button></a>
                                </div>
                                <div class='menufriend col-12 text-center'>
                                    ...
                                    <div class="colzmianyele col-7">
                                        <form method="post" >
                                            <div class="row justify-content-md-center">
                                                ...
                                                <div class="col-10">
                                                    <input class="reginput" type="email" name="new_email_1" placeholder="Nowy email">
                                                </div>
                                                <div class="col-10">
                                                    <input class="reginput" type="email" name="new_email_2" placeholder="Powtórz nowy email">
                                                </div>
                                                <div class="col-10">
                                                    <button class="regbutton" name="change_email" type="submit">ZMIEŃ EMAIL</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>  
