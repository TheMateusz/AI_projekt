<?php 
    ...
    $zapytanie2 = "SELECT * FROM users WHERE username='$nick'";
    $results4 = mysqli_query($db, $zapytanie2);
    $ilu_userow1 = $results4->num_rows;
    if($ilu_userow1>0)
    {
        $wiersz = $results4->fetch_assoc();
        $_SESSION['cuseropis'] = $wiersz['opis'];
    } 
    $copis = $_SESSION['cuseropis'];
                                    ...
                                    <div class="colzmianyele col-10">
                                        <form method="post" enctype='multipart/form-data'>
                                            <div class="row justify-content-md-center">
                                                ...
                                                <div class="col-10">
                                                    <textarea class="btn btn-dark btn-block" rows="8" name="opis"></textarea>
                                                </div>
                                                <div class="col-10 text-center">
                                                    <button class="regbutton" name="change_des" type="submit">ZMIEŃ OPIS</button>
                                                </div>
                                                <br>
                                            </div>
                                        </form>
