                                    ...
                                    <div class="colzmianyele col-7">
                                        <form method="post" >
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-10">
                                                    <input class="reginput" type="text" name="wiek" placeholder="Podaj wiek">
                                                </div>
                                                <div class="col-10">
                                                    <button class="regbutton" name="change_wiek" type="submit">ZMIEŃ WIEK</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>       
                                    <div class="colzmianyele col-7">
                                        <form method="post" >
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-10">
                                                    <input class="reginput" type="text" name="panstwo" placeholder="Podaj państwo">
                                                </div>
                                                <div class="col-10">
                                                    <input class="reginput" type="text" name="miasto" placeholder="Podaj miasto">
                                                </div>
                                                <div class="col-10">
                                                    <button class="regbutton" name="change_pol" type="submit">ZMIEŃ MIEJSCE ZAMIESZKANIA</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div> 
